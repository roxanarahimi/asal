    ...
    <h3 class="my-color mb-0"></h3>
      ...
      <ul class="px-0 pe-2 " style="list-style: none; align-self: center">
        <li class="d-flex">
          ...
          <p>
            تامین کمبود مواد غذایی زنبورها
          </p>
        </li>
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
        ...
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
          <p>
            در موقع تولید ملکه و یا زنبور پاکتی که باید جمعیت کندوها بالا باشد.
          </p>
        </li>
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
          <p>
            نگهداری کلنی ها و طولانی نمودن فصل پرورش زنبورهای نر جهت جفت گیری با ملکه.
          </p>
        </li>
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
        ...
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
          <p>
            کمک به کلنی های ضعیف یا غارت شده
          </p>
        </li>
        <li class="d-flex">
          <div class="text-start" style="width: 15px; height: 15px; "><i class="bi bi-dash my-color"></i></div>
